 ...
 * POST /api/chat/send
 * Body supports both:
 *  - { rentalId, senderId, receiverId, message }
 *  - { rentalId, from, to, text }   (in case your frontend uses these names)
 */
...
/**
 * Helper used by socket.io in server.js
...
/**
 * (Optional) Mark all messages as seen by a given user for a rental
