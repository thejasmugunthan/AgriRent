    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl font-semibold text-gray-600 mt-4">Loading machine details...</p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl shadow-lg p-6 mb-6">
          ...
          <p className="text-green-50 mt-2">View complete information about this machine</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div>
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              {/* Book Button */}
              <button
                onClick={() => navigate(`/rent-machine/${machineId}`)}
