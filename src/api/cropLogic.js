...
// Recommendation map for crop -> likely machines
...
// Seasonal demand multipliers (rough)
...
// Crop importance baseline (how much demand crop creates)
...
export function getCropInfo(crop = "Rice", season = "Monsoon") {
  ...
  // demandMultiplier is small modifier applied to baseline demand_index (0.6-1.2)
