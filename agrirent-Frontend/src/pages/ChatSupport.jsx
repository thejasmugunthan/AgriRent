    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Invalid Chat Session</h2>
          <p className="text-gray-600 mb-6">This chat session could not be found or is no longer valid.</p>
          <button
            onClick={() => navigate(-1)}
